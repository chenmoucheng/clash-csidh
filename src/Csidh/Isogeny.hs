...
scalarMultiplicationMontgomeryPlus :: (Algebra.Ring.C t, BitPack t, Eq t, Algebra.Ring.C k, Eq k) => (t, k, k, k) -> (k, k)
...
actWithEllOnMontgomeryPlus :: (Algebra.Field.C k, Eq k, Algebra.Ring.C t, BitPack t, Eq t, Ord t) => (k, t, k, k) -> (k, k, k)
...
prop_scalarMultiplicationIsHomomorphic :: (Algebra.Ring.C t, BitPack t, Eq t, Algebra.Ring.C k, Eq k) => t -> t -> k -> k -> Bool
...
prop_groupActionCommutesWithScalarMultiplication :: (Algebra.Ring.C t, BitPack t, Eq t, Ord t, Algebra.Field.C k, Eq k) => t -> k -> t -> k-> Bool
